...
module.exports = {
    opts: {
        ...
        /*
            ...
            `/docs/enketo-validate/[version number]/index.html` instead of simply
    ...
    docdash: {
        ...
        menu: {
            'Github repo': {
                href: 'https://github.com/enketo/enketo-validate',
                target: '_blank',
                class: 'menu-item',
                id: 'repository'
            },
            'Change log': {
                href: 'https://github.com/enketo/enketo-validate/blob/master/CHANGELOG.md',
                target: '_blank',
                class: 'menu-item',
                id: 'change-log'
            }
